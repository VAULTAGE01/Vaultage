...
const privateOverlaySourcePatterns = [
  ...
  /^scripts\/(?:build-commercial-(?:beta|production)\.sh|commercial-(?:beta|production)-release\.test\.mjs|write-release-build-manifest(?:\.test)?\.mjs)$/,
...
export const reviewedDisabledSeamPaths = new Set([
  ...
  'src/renderer/src/commercialSetupAccount.disabled.ts',
...
export const openWebAliasPaths = {
  ...
  '#commercial-setup-account': ['src/renderer/src/commercialSetupAccount.disabled.ts'],
...
export const openNodeTypecheckExclude = [
  ...
  'src/main/agentProjectContextHttp.ts',
  'src/main/agentRelease.ts',
  'src/main/agentServer.ts',
  'src/main/agentServerPort.ts',
