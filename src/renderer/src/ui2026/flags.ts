...
const DEFAULT_FLAGS: Ui2026Flags = Object.freeze({ vault: false, projects: false, services: false })
...
export const ui2026Flags = parseUi2026Flags(
  typeof __VAULTAGE_UI2026_FLAGS__ === 'undefined' ? undefined : __VAULTAGE_UI2026_FLAGS__,
)

export function isUi2026Enabled(surface: Ui2026Surface, flags: Ui2026Flags = ui2026Flags): boolean {
