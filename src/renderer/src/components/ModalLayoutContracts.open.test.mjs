...
describe('Community modal visual contracts', () => {
  it('keeps modal surfaces neutral and content-dense dialogs wide', () => {
    ...
    expect(indexCss).toContain('--liquid-modal-bg:        rgba(7, 9, 10, 0.84)')
    expect(indexCss).toContain('background-color: var(--liquid-modal-bg) !important')
    expect(indexCss).toContain('background-color: var(--liquid-modal-card) !important')
    expect(indexCss).toContain('background-color: var(--liquid-modal-soft) !important')
