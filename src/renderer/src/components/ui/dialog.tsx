  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'liquid-modal-shell no-drag w-full max-w-6xl overflow-hidden rounded-2xl border p-0 shadow-modal',
...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn('flex items-center justify-end gap-2 px-6 py-4 border-t border-border bg-white/[0.035]', className)} {...props} />
)
